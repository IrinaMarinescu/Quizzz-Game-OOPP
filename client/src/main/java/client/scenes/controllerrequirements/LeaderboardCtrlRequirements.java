...
public interface LeaderboardCtrlRequirements {
    ...
    /**
     * <p>The <code>initialize</code> function will fill the
     * leaderboard table with entries and also set the max size and the type of leaderboard to be shown.</p>
     * <p>Other private, helper methods are implemented in LeaderboardCtrl.
     * There should be no need to call on those.</p>
     *
